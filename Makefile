.PHONY: install install-hooks dev lint format format-check typecheck commit-check pre-push-check check migrate downgrade seed test test-integration test-ui check-shioaji-isolation
