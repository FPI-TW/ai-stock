...
class CurrentPriceData(BaseModel):
    ...
    quote_time: datetime | None = Field(serialization_alias="quoteTime")
...
def map_current_price(snapshot: QuoteSnapshot, *, source: str) -> CurrentPriceData:
    return CurrentPriceData(
        ...
        quote_time=snapshot.last_trade_time,
